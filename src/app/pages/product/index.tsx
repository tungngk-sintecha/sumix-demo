...
export default function ProductPage() {
  return (
    <section className="px-8 lg:px-14 border-t border-app-light-gray mt-20 max-w-[1440px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div>
          <div className="space-y-4 pb-6 border-b border-app-light-gray">
            <h1 className="text-app-black font-poppins text-[26px]/[30px] font-medium tracking-[-0.4px]">
              Tray Table
            </h1>
            <div className="flex gap-3 items-end">
              <p className="text-app-black font-poppins text-[40px]/[44px] font-semibold tracking-[-0.6px]">
                $199.00
              </p>
              <p className="text-app-gray font-poppins text-[16px]/[20px] font-semibold tracking-[-0.6px] line-through">
                $400.00
              </p>
            </div>
            <div className="flex gap-x-4 items-center">
              <div className="bg-red-500 text-white px-4 font-semibold">
                Save
              </div>
              <p className="font-bold text-[18px]/[22px] text-red-500">
                - $201.00
              </p>
            </div>
                    ...
                    <div className="flex gap-10 pb-6">
                      ...
                      <div className="w-full space-y-4">
                        ...
                        <p className="hidden md:block text-app-slate-gray font-inter text-base/[26px] font-normal">
                          ...
                          corrupt et quas molestias excepturi sint non
                          provident.
                        </p>
                        <div className="hidden md:flex gap-4 mt-2">
                          <p className="text-app-gray font-inter text-xs/5 font-normal">
